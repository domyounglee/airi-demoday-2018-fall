      ...
      <div class="navbar navbar-dark bg-dark box-shadow">
        <div class="container d-flex justify-content-between">
          ...
          <a href="#" id="chat-hide" class="navbar-brand d-flex align-items-center">
            <strong>AI Manual : 맹뉴얼  by <font color=red> AIRI </font> </strong>
          </a>
      </div>
    </header>
    		...
    		<div class="col-md-6" style="height:800px;">
			   <div class="card">
               			  <div class="card-body" style="height: 700px;">
								...
								<input type="image" name="build" id="build" src="./cau.png" style="height: 55px;width: 49%;padding-top:0.5rem;" onclick="callcau()"/>
								<input type="image" name="build" id="build" src="./war.png" style="height: 55px;width: 49%;padding-top:0.5rem;" onclick="callwar()"/>
  		                  </div>
            		   </div>
                </div>
